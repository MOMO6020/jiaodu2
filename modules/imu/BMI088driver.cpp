...
void Calibrate_MPU_Offset(IMU_Data_t* bmi088)
{
    ...
    startTime = STM32TimeDWT::GetMilliseconds() / 1000.0f;
    do
    {
        if (STM32TimeDWT::GetMilliseconds() / 1000.0f - startTime > 12)
        {
            bmi088->GyroOffset[0] = GxOFFSET;
            bmi088->GyroOffset[1] = GyOFFSET;
            bmi088->GyroOffset[2] = GzOFFSET;
...
uint8_t bmi088_accel_init(void)
{
    ...
    {
        LOGERROR("BMI088", "[bmi088] Can not read bmi088 acc chip id");
...
uint8_t bmi088_gyro_init(void)
{
    ...
    {
        LOGERROR("BMI088", "[bmi088] Can not read bmi088 gyro chip id");
        return BMI088_NO_SENSOR;
    }
